...
IF %ERRORLEVEL% NEQ 0 (
    ...
    REM Set the path to the downloaded OpenJDK .msi installer
    ...
    REM Check if the .msi installer exists in the specified directory
    IF EXIST "%LOCAL_JDK_PATH%\OpenJDK17U-jdk_x64_windows_hotspot_17.0.13_11.msi" (
        ...
        REM We will now also check inside "Program Files" for the installation
        IF EXIST "%INSTALL_DIR%\jdk-17\bin\java.exe" (
            ...
            REM Try checking other common install paths
